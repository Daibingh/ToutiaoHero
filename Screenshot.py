...
class Screenshot(QWidget):
    ...
    def __init__(self, parent = None):
        ...
        # 屏幕 和 屏幕信息
        self.screen = QGuiApplication.primaryScreen().grabWindow(QApplication.desktop().winId())
        ...
        # print(self.screen.rect())
        self.setGeometry(self.screen.rect())
        # print(self.geometry())
    ...
    def capture(self):
        pixmap = self.screen.copy()
        if self.hasPattern:
            painter = QPainter(pixmap)
            painter.drawPixmap(self.canvas)
        pixmap = pixmap.copy(toRect(self.maskRect))
